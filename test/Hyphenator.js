    ...
    var contextWindow = window,
        ...
        createValueStore = function (lo) {
            var ValueStore = function (len) {
                this.keys = (function () {
                    var i, r;
                    if (Object.prototype.hasOwnProperty.call(global, "Uint8Array")) { //IE<9 doesn't have window.hasOwnProperty (host object)
        ...
        convertPatternsToArray = function (lo) {
            ...
            createValueStore(lo);
            if (Object.prototype.hasOwnProperty.call(global, "Int32Array")) { //IE<9 doesn't have window.hasOwnProperty (host object)
            ...
            for (lang in docLanguages) {
                if (docLanguages.hasOwnProperty(lang)) {
                    if (!!storage && storage.test(lang)) {
                        ...
                        if (Object.prototype.hasOwnProperty.call(global, "Int32Array")) {
                            Hyphenator.languages[lang].indexedTrie = new Int32Array(Hyphenator.languages[lang].indexedTrie);
                            Hyphenator.languages[lang].valueStore.keys = new Uint8Array(Hyphenator.languages[lang].valueStore.keys);
                        }
        ...
        hyphenateWord = function (lo, lang, word) {
            ...
            if (word === '') {
                ...
                ww = '_' + ww + '_';
                wwlen = ww.length;
                if (Object.prototype.hasOwnProperty.call(global, "Uint8Array")) {
                    wwhp = new Uint8Array(wwlen);
                    wwAsMappedCharCode = new Int32Array(wwlen);
                } else {
                    wwhp = [];
                    wwAsMappedCharCode = [];
